package com.ldt.fahimshariar.ui.widget.avsb;

import androidx.annotation.NonNull;
import androidx.annotation.WorkerThread;

import com.ldt.fahimshariar.interactors.AppExecutors;
import com.ldt.fahimshariar.interactors.MainThreadUtils;
...
class VisualSeekBarParser implements ProgressListener {
    ...
    protected com.ldt.fahimshariar.ui.widget.soundfile.SoundFile mSoundFile;
    ...
    void parse(Song song) {
        AppExecutors.io().execute(() -> {
                    ...
                    try {
                        mSoundFile = com.ldt.fahimshariar.ui.widget.soundfile.SoundFile.create(song, this);
                        //Thread.sleep(2500);
