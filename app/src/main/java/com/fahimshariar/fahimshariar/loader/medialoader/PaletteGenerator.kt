package com.fahimshariar.fahimshariar.loader.medialoader

import android.content.Context
import com.ldt.fahimshariar.utils.ArtworkUtils.getBitmapRequestBuilder
...
import com.fahimshariar.fahimshariar.util.BitmapEditor
...
class PaletteGenerator {
    ...
    private fun runInternal() {
        ...
        val context: Context = _root_ide_package_.com.fahimshariar.fahimshariar.App.getInstance() ?: return
        try {
            val song = _root_ide_package_.com.fahimshariar.fahimshariar.service.MusicPlayerRemote.getCurrentSong()
        ...
        _root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.setMostCommonColor(color)
        _root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.setSurfaceColor(color)
        ...
        if (!isCancelled && generated) {
            ...
            // re-assign colors
            _root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.ColorOne = outColors[0]
            _root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.ColorTwo = outColors[1]
            _root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.AlphaOne = outAlphas[0]
            _root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.AlphaTwo = outAlphas[1]
    ...
    private fun generatedPalette(p: Palette, outColors: IntArray, outAlphas: FloatArray): Boolean {
        ...
        Color.colorToHSV(_root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.getMostCommonColor(), hsv)
        ...
        {
            color1 = _root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.getMostCommonColor()
            alpha1 = 1f
            color2 = _root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.getBaseColor()
            alpha2 = alpha7basic
        } else  // ngược lại thì màu basic sẽ là màu song name
        {
            val tempColor1 = getBestColorFromPalette(palette)
            color1 = if (tempColor1 == 0) _root_ide_package_.com.fahimshariar.fahimshariar.util.Tool.getBaseColor() else tempColor1
            alpha1 = 1f
            color2 = Color.WHITE
            alpha2 = 0.7f
        }
    ...
    private fun getMostColor(origin: Bitmap): Int {
        ...
        var sample: Bitmap? = _root_ide_package_.com.fahimshariar.fahimshariar.util.BitmapEditor.getResizedBitmap(origin, origin.height / 38, origin.width / 38)
        sample = _root_ide_package_.com.fahimshariar.fahimshariar.util.BitmapEditor.updateSat(sample, 4f)
        sample = _root_ide_package_.com.fahimshariar.fahimshariar.util.BitmapEditor.fastblur(sample, 1f, 4)
        val averageColorRGB = _root_ide_package_.com.fahimshariar.fahimshariar.util.BitmapEditor.getAverageColorRGB(sample)
    ...
    companion object {
        const val PALETTE_CHANGED = "com.ldt.fahimshariar.PALETTE_CHANGED"
