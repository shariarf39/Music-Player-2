...
import com.ldt.fahimshariar.ui.widget.viewpager.GestureControlViewPager
...
import com.fahimshariar.fahimshariar.ui.CardLayerController.CardLayerAttribute
...
import com.fahimshariar.fahimshariar.glide.ArtistGlideRequest
import com.fahimshariar.fahimshariar.glide.GlideApp
...
import com.ldt.fahimshariar.interactors.postOnUiThread
...
class BackStackController : _root_ide_package_.com.fahimshariar.fahimshariar.ui.maintab.CardLayerFragment(), OnPageChangeListener {
    ...
    private var mNavigationAdapter: _root_ide_package_.com.fahimshariar.fahimshariar.ui.maintab.BottomNavigationPagerAdapter? = null
    private var dpX1 = 1f
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mNavigationAdapter =
            _root_ide_package_.com.fahimshariar.fahimshariar.ui.maintab.BottomNavigationPagerAdapter(
                activity,
    ...
    fun attachBottomNavigationView(activity: _root_ide_package_.com.fahimshariar.fahimshariar.ui.AppActivity) {
    ...
    fun navigateToLibraryTab(go: Boolean): _root_ide_package_.com.fahimshariar.fahimshariar.ui.maintab.library.LibraryTabFragment? {
        val fragment = navigateToTab(go)
        return if (fragment is _root_ide_package_.com.fahimshariar.fahimshariar.ui.maintab.library.LibraryTabFragment) {
            fragment
        } else null
    }
    ...
    private fun navigateToTab(go: Boolean, item: Int = 1): Fragment? {
        ...
        if (fragment is _root_ide_package_.com.fahimshariar.fahimshariar.ui.widget.navigate.BackPressableFragment) {
    ...
    private fun updateBackImage() {
        AppExecutors.io().execute {
            val isUseArtistImageAsBackground = _root_ide_package_.com.fahimshariar.fahimshariar.App.getInstance().preferencesUtility.isUsingArtistImageAsBackground
            val currentSong = if(isUseArtistImageAsBackground) _root_ide_package_.com.fahimshariar.fahimshariar.service.MusicPlayerRemote.getCurrentSong() else null
            ...
            postOnUiThread {
                if(isAdded && !isRemoving) {
                    ...
                    _root_ide_package_.com.fahimshariar.fahimshariar.glide.ArtistGlideRequest.Builder.from(
                        _root_ide_package_.com.fahimshariar.fahimshariar.glide.GlideApp.with(requireContext()), artist)
                        .requestHighResolutionArt(true)
                        .generateBuilder(context)
                        .build()
                        .thumbnail(
                            _root_ide_package_.com.fahimshariar.fahimshariar.glide.ArtistGlideRequest.Builder
                                .from(_root_ide_package_.com.fahimshariar.fahimshariar.glide.GlideApp.with(requireContext()), artist)
