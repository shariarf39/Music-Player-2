package com.fahimshariar.fahimshariar.ui.floating
...
import com.ldt.fahimshariar.common.AppConfig.systemBarsInset
...
import com.fahimshariar.fahimshariar.ui.base.FloatingViewFragment
import com.ldt.fahimshariar.ui.maintab.library.adapter.MediaAdapter
import com.ldt.fahimshariar.ui.widget.view.MPSearchView
import com.ldt.fahimshariar.utils.SearchUtils
import com.fahimshariar.fahimshariar.util.Tool
import com.fahimshariar.fahimshariar.utils.KeyboardUtils
import com.ldt.fahimshariar.utils.ViewUtils
import com.simplecityapps.recyclerview_fastscroll.views.FastScrollRecyclerView
import com.zalo.gitlabmobile.notification.MessageEvent
import org.greenrobot.eventbus.EventBus
import org.greenrobot.eventbus.Subscribe

class SearchFragment: _root_ide_package_.com.fahimshariar.fahimshariar.ui.base.FloatingViewFragment(R.layout.screen_search_floating) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        postDelayedOnUiThread(250) {
            ...
            _root_ide_package_.com.fahimshariar.fahimshariar.utils.KeyboardUtils.showSoftInput(searchView.searchEditText)
        }
            ...
            override fun onScrollStateChanged(recyclerView: RecyclerView, state: Int) {
                when (state) {
                    RecyclerView.SCROLL_STATE_DRAGGING -> if (!isKeyboardDismissedByScroll) {
                        _root_ide_package_.com.fahimshariar.fahimshariar.utils.KeyboardUtils.hideSoftInput(searchView.searchEditText)
    ...
    override fun onDetach() {
        ...
        _root_ide_package_.com.fahimshariar.fahimshariar.utils.KeyboardUtils.hideSoftInput(activity)
    ...
    private fun search(text: String) {
        AppExecutors.io().execute {
            ...
            val srcTopHitSongs = mutableListOf<_root_ide_package_.com.fahimshariar.fahimshariar.model.Song>()
            ...
            val desTopHitSongs = mutableListOf<_root_ide_package_.com.fahimshariar.fahimshariar.model.Song>()
