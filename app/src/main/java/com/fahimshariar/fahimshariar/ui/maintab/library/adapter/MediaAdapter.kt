package com.fahimshariar.fahimshariar.ui.maintab.library.adapter
...
import com.fahimshariar.fahimshariar.helper.songpreview.SongPreviewListener
...
import com.ldt.fahimshariar.notification.PayLoadKey
import com.ldt.fahimshariar.notification.ViewTypeKey
import com.fahimshariar.fahimshariar.service.MusicPlayerRemote
import com.ldt.fahimshariar.ui.maintab.library.viewholder.*
import java.lang.IllegalArgumentException

/**
 * Ghost Adapter that binds not only media item but also media view control
 */
open class MediaAdapter: AbsListAdapter<DataItem, RecyclerView.ViewHolder>(),
    _root_ide_package_.com.fahimshariar.fahimshariar.helper.songpreview.SongPreviewListener, ActionResponder {
    var actionResponder: ActionResponder? = null
    var previewingSong: _root_ide_package_.com.fahimshariar.fahimshariar.helper.songpreview.PreviewSong? = null
    ...
    override fun onSongPreviewStart(song: _root_ide_package_.com.fahimshariar.fahimshariar.helper.songpreview.PreviewSong?) {
        song ?: return
    ...
    override fun onSongPreviewFinish(song: _root_ide_package_.com.fahimshariar.fahimshariar.helper.songpreview.PreviewSong?) {
        previewingSong = null
    ...
    fun onPlayingStateChanged() {
        ...
        AppExecutors.io().execute {
            val playingIdNew = _root_ide_package_.com.fahimshariar.fahimshariar.service.MusicPlayerRemote.getCurrentSong().id
            val playingStateNew = _root_ide_package_.com.fahimshariar.fahimshariar.service.MusicPlayerRemote.isPlaying()
