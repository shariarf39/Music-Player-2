...
object SearchPreProcessingProvider {
    ...
    @JvmStatic
    fun get(input: String, @_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.PreprocessFlag flags: Int): PreProcessingOutput {
        val map = maps[flags]
    ...
    @JvmStatic
    private fun create(input: String, @_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.PreprocessFlag flags: Int): PreProcessingOutput {
        return when {
            flags.hasFlags(_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_TYPE_KEY) -> SearchPreProcessingUtils.preprocessTypeKey(input, flags)
            flags.hasFlags(_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_TYPE_KEY_NBS) -> SearchPreProcessingUtils.preprocessTypeKeyUsername(input, flags)
