...
import com.ldt.fahimshariar.model.core.Entity
import java.util.*
...
object SearchUtils {
     ...
     */
    @JvmStatic
    fun <T> filterTopHitEntities(srcList: List<T>, desList: MutableList<T>, keyword: String, @_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.MatchFlag flags: Int = 0) where T : Entity {
        srcList.forEach {
    ...
    private fun retrieveMatchScore(
        ...
        @_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.MatchFlag flags: Int = 0
    ): Float {
        var matchScore = 0f
        ...
        val arrayItemWordOrg: Array<String> = when {
            paramArrayItemWord != null -> {
                ...
                if (hasFlags(flags, _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE)) {
            ...
            search != null -> {
                ...
                val searchOutputOrg = SearchPreProcessingProvider.get(
                    search,
                    _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_TYPE_SEARCH or (if (hasFlags(
                            flags,
                            _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE
                        )
                    ) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE else 0) // this flag should always be unset
                            or (if (splitWordExtendTypeSearchEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_EXTEND else 0)
                            or if (splitWordEnhancedTypeSearchEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_ENHANCED else 0
                )
                ...
                arrayItemWordLowercase =
                    if (hasFlags(flags, _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE)) searchOutputOrg.arrayWords else SearchPreProcessingProvider.get(
                        search,
                        _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_TYPE_SEARCH or _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE
                                or (if (splitWordExtendTypeSearchEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_EXTEND else 0)
                                or if (splitWordEnhancedTypeSearchEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_ENHANCED else 0
                    ).arrayWords
                arrayItemWordKeepAccents = SearchPreProcessingProvider.get(
                    ...
                    (_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_TYPE_SEARCH or _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE
                            or (if (splitWordExtendTypeSearchEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_EXTEND else 0)
                            or (if (splitWordEnhancedTypeSearchEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_ENHANCED else 0)
                            or _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_KEEP_ACCENTS)
                ).arrayWords
        ...
        val arrayKeyWord: Array<String> = when {
            ...
            key != null -> {
                ...
                val arrayKeyWord = if (hasFlags(flags, _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_SEARCH_NBS)) SearchPreProcessingProvider.get(
                    key,
                    (_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_TYPE_KEY_NBS or _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE
                            or (if (splitWordExtendTypeKeyEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_EXTEND else 0)
                            or (if (splitWordEnhancedTypeKeyEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_ENHANCED else 0))
                ).arrayWords else SearchPreProcessingProvider.get(
                    key,
                    (_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_TYPE_KEY or _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE
                            or (if (splitWordExtendTypeKeyEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_EXTEND else 0)
                            or (if (splitWordEnhancedTypeKeyEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_ENHANCED else 0))
                ).arrayWords
                arrayKeyWordKeepAccents = if (hasFlags(flags, _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_SEARCH_NBS)) SearchPreProcessingProvider.get(
                    key, (_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_TYPE_KEY_NBS or _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE
                            or (if (splitWordExtendTypeKeyEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_EXTEND else 0)
                            or (if (splitWordEnhancedTypeKeyEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_ENHANCED else 0)
                            or _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_KEEP_ACCENTS)
                ).arrayWords else SearchPreProcessingProvider.get(
                    key,
                    (_root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_KEEP_ACCENTS or _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE
                            or (if (splitWordExtendTypeKeyEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_EXTEND else 0)
                            or (if (splitWordEnhancedTypeKeyEnabled) _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_SPLIT_WORD_ENHANCED else 0)
                            or _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_PREPROCESS_KEEP_ACCENTS)
                ).arrayWords
        ...
        for (i in arrayKeyWord.indices)  //for each work in key word string - example: One Two Three
        {
            ...
            for (t in 0 until sizeDpnElement)  // for each work in Display name string - example: Peter One.
            {
                ...
                while (index >= 0 && countLoopToFind <= 10) {
                    if (index >= 0) {
                        var match = false
                        if (hasFlags(flags, _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_ALLOW_MATCH_CASE_CONTAIN)) {
...
//                    }
    ...
    private fun filterTopHitSample() {
        ...
        srcList.forEach {
            val matchScore = retrieveMatchScore(null, null, emptyArray(), emptyArray(), it, it.spanPosList, _root_ide_package_.com.fahimshariar.fahimshariar.utils.SearchConstant.SEARCH_FLAG_TO_LOW_CASE)
        }
    }
